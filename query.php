...
<link rel="stylesheet" href="http://yue.huidge.top/css/style.css" /> 
...
<!--
      <div class="weui-cell"> 
       ...
       <div class="weui-cell__bd"> 
        <input class="weui-input" type="text"  name="sno" placeholder="请输入学号"
        autofocus="autofocus"/> 
       </div> 
      </div>
-->
    ...
    <div class="weui-btn-area">
    <a href="./index.html" class="weui_btn weui_btn_primary">
     <input class="weui-btn weui-btn_primary" type="button" value="新增" >
     </a> 
    </div> 
     </form>
    <?php
...
include('connect.php');//链接数据库
  //向数据库插入表单传来的值的sql
    ...
    while($row = mysqli_fetch_array($result)) {
      ...
      <div class='weui-cell__bd'><input class='weui-input' type='text' value='".$row['name']."' id='name'></div></div>";
      echo "<div class='weui-cell'>
      <div class='weui-cell__hd'><label class='weui-label'>学号</label></div>
      <div class='weui-cell__bd'><input class='weui-input' type='text' value='".$row['sno']."' id='sno'></div></div>";
      echo "<div class='weui-cell'>
      <div class='weui-cell__hd'><label class='weui-label'>手机</label></div>
      <div class='weui-cell__bd'><input class='weui-input' type='text' value='".$row['tel']."' id='tel'></div></div>";  
      echo "<div class='weui-cell'>
      <div class='weui-cell__hd'><label class='weui-label'>准考证号</label></div>
      <div class='weui-cell__bd'><input class='weui-input' type='text' value='".$row['haoma']."' id='haoma'></div></div>";  
      echo "</div>";
        }
...
<div class="weui-cells__tips">
      <span>注意事项: </span><br/>
      <span>本系统仅可查询已登记学生准考证信息！</span>
</div>
<center>
<font color='#666666'> 
©2017 
<a href="https://mp.weixin.qq.com/mp/profile_ext?action=home&__biz=MzA3NTEwNjU0OA==#wechat_redirect">
<svg aria-hidden="true" class="icon"> <use xlink:href="#icon-weixin"></use> </svg>
<span>Hauster小助手</span>
</a> 
版权所有
</font>
</center><br>   
